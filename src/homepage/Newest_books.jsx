...
export default function Suggestions() {
  ...
  useEffect(() => {
    const fetchSuggestions = async () => {
      ...
      try {
        const response = await fetch(`https://batbooks.liara.run/newest/book/`, {
          method: "GET",
          headers: {
  ...
  return (
    <div dir="rtl">
      <div className="w-full lg:h-[90vh] m-auto  py-[30px] md:pb-[40px] lg:py-[50px]  relative overflow-hidden bg-[#D9F0FF] ">
        ...
        >
          ...
          <span className="m-auto lg:absolute  -bottom-8 right-12 w-35  h-2 bg-gradient-to-l from-[#6f6fff] to-[#2828db] rounded-full z-0"></span>
        </motion.h1>
