...
function ReplyBox({ isLast, commentId, setHidden }) {
  ...
  const handleSubmitReply = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://batbooks.liara.run/comments/reply_to/${commentId}/`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
...
function LikeAndDislike({ likeNum, dislikeNum, likeState, commentorreplyId }) {
  ...
  const toggleLike = async () => {
    try {
      ...
      const token = localStorage.getItem("access_token");
      const response = await fetch(
        `https://batbooks.liara.run/comments/like/${commentorreplyId}/`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  const toggleDislike = async () => {
    try {
      ...
      const token = localStorage.getItem("access_token");
      const response = await fetch(
        `https://batbooks.liara.run/comments/dislike/${commentorreplyId}/`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
