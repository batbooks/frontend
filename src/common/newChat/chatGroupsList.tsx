...
const GroupChatList: React.FC<Props> = ({ onGroupSelect, setChatContext ,chatContext}) => {
...
>
  ...
  <ul className="divide-y overflow-y-auto flex-grow">
    {isLoading && (
      <li className="p-2 py-3 text-center text-slate-500">در حال بارگذاری گروه‌ها...</li>
    )}
