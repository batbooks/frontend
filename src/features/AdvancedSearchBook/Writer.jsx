    ...
    <div className="flex flex-col gap-[17px] w-full lg:w-3/10">
      ...
      <div className="relative group">
        <input
          ...
          className="2xl:mr-[30px] px-[18px] bg-white w-full h-[43px] rounded-[6px] outline-[2px] outline-[#000000]/21 focus:outline-[3px] focus:outline-[#2663CD] placeholder:text-[16px] placeholder:font-[300] placeholder:text-[#265073]"
        />
