  ...
  return (
    <>
      ...
      >
        ...
        {searchingItem === "book" ? <SearchFilters /> : null}
...
function SharedStateProvider({ children }) {
  ...
  return (
    <SharedStateContext.Provider
      value={{ isVisibleDescription, setIsVisibleDescription }}
    >
      {children}
    </SharedStateContext.Provider>
  );
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      >
        <div className="flex flex-col gap-[17px] w-full">
          <div className="flex justify-between items-center">
            <div className="flex gap-[3px] items-center">
              ...
              />
              <h2 className="text-[20px] font-[300] ">فیلترها ({filterNum})</h2>
            </div>
        ...
        <div className="grid grid-cols-5 gap-x-[25px] gap-y-[33px] mx-[30px] p-[20px] bg-[#FFF] rounded-[15px] border-[2px] border-[#000000]/21 mb-[50px]">
          {loading ? (
            <Loading />
          ) : (
        ...
        <h2 className="text-[20px] font-[300]  mb-[17px]">دسته بندی تگ ها:</h2>
        <div className="grid grid-cols-5 gap-x-[25px] gap-y-[33px] mx-[30px] p-[20px] bg-[#FFF] rounded-[15px] border-[2px] border-[#000000]/21 mb-[17px]">
          {loading
            ? null
        ...
        ></input>
        <div className="grid grid-cols-5 max-h-[155px] overflow-y-scroll overflow-x-visible gap-x-[25px] gap-y-[33px] mx-[30px] p-[20px] bg-[#FFF] rounded-[15px] border-[2px] border-[#000000]/21 mb-[50px]">
          {loading
            ? null
            : showingSelectedTags.map((tag) => (
                <SharedStateProvider key={tag.id}>
                  <SelectedGenreAndTag
                    Obj={tag}
                    deleteFilter={setFilters}
                    filters={filters}
                    ...
                    <div className="flex flex-col items-center">
                      <button
                        onClick={() => {
                          if (avgScoreFrom > 1) {
                            if (
                              avgScoreFrom.toFixed(1) === avgScoreTo.toFixed(1)
                            ) {
                              setFilters((filters) =>
                                filters?.filter(
                                  (filter) =>
                                    !filter.includes("میانگین امتیاز: ")
                                )
                              );
                              ...
                              if (
                                !(avgScoreFrom <= 1.15 && avgScoreFrom >= 1.1)
                              ) {
                                setFilters((filters) => [
                                  ...(filters || []),
                                  `میانگین امتیاز: از ${(avgScoreFrom - 0.1).toFixed(1)}`,
                        ...
                        onClick={() => {
                          if (avgScoreTo < 5) {
                            if (
                              ...
                              if (
                                !(avgScoreFrom <= 1.05 && avgScoreFrom >= 1)
                              ) {
                                setFilters((filters) => [
                                  ...(filters || []),
          ...
          <div className="flex flex-col gap-[17px]">
            ...
            <div className="relative group">
              <input
                ...
                className=" mr-[30px] px-[18px] shadow-lg shadow-[#000]/25 bg-white w-[287px] h-[43px] rounded-[45px] outline-[2px] outline-[#000000]/10 focus:outline-[3px] focus:outline-[#2663CD] focus:shadow-none"
              />
        ...
        <button className="btn !w-fit !h-fit !mb-0 px-[26px] py-[12px] !rounded-[20px] outline-[2px] outline-[#000000]/21">
          <span className="span-btn !text-[16px] !font-[400]">
            اعمال تمامی فیلترها
          </span>
        </button>
        ...
        <button
          onClick={() => {
            if (checkedNum === -1) {
              ...
              setCheckedNum(-1);
              addFilter(
                filters?.filter((filter) => filter !== "وضعیت: به اتمام رسیده")
              );
            } else {
              setCheckedNum(1);
              addFilter((filters) =>
        ...
        <button
          onClick={() => {
            if (checkedNum === -1) {
              ...
              addFilter((filters) => [...(filters || []), "وضعیت: متوقف شده"]);
            }
          }}
          className="rounded-full cursor-pointer h-[30px] w-[30px] hover:bg-[#E5E5E5]/30 transition-colors duration-400 active:bg-[#E5E5E5]/50 active:duration-100"
        >
...
function FromToInputs({ maxValue, valueLength, setFilters, filterPattern }) {
